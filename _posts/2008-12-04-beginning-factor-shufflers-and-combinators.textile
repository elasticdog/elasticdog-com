...
bc. (scratchpad) 5 [ "hello" print ] times
hello
hello
hello
hello
...
bc. (scratchpad) "hello" dup dup dup dup print print print print print
hello
hello
hello
hello
...
bc. (scratchpad) { 1 2 3 } dup sum swap length / .
2
...
bc. (scratchpad) { 1 2 3 } [ sum ] [ length ] bi / .
2
...
bc. (scratchpad) { 1 2 } { 3 4 } swap first swap second 2array .
{ 1 4 }
...
bc. (scratchpad) { 1 2 } { 3 4 } [ first ] [ second ] bi* 2array .
{ 1 4 }
...
bc. (scratchpad) "john" "John" swap >upper swap >upper = .
t
...
bc. (scratchpad) "john" "John" [ >upper ] bi@ = .
t
...
bc. (scratchpad) { 1 2 3 4 5 } [ even? ] filter .
{ 2 4 }
