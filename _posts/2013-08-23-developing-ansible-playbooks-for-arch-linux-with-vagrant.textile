...
The prerequisites for running the bootstrap script include assigning a known IP address to the machine via the "Vagrantfile":http://docs.vagrantup.com/v2/vagrantfile/index.html:
...
...recording that same IP in an "inventory file":http://ansibleworks.com/docs/patterns.html named @hosts@ for Ansible to reference:
