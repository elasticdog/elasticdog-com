...
Optimal Title uses the same syntax as "@wp_title@":http://codex.wordpress.org/Template_Tags/wp_title, from the default WP installation, and thus functions in the exact same way...
