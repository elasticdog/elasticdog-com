...
# There's no guarantee that all <abbr title="WordPress">WP</abbr> users will be able to create, edit, and use <kbd>.htaccess</kbd> files. Some hosting companies just don't allow it.
