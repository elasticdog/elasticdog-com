...
The idea to use ordered lists in XHTML to present code, originated from Simon Willison's "CSS Numbered Code Listings":http://simon.incutio.com/archive/2002/07/10/numberedCodeListing blog entry. The same idea has been used by other designers, and in particular, a fellow WP plugin author named David House...
