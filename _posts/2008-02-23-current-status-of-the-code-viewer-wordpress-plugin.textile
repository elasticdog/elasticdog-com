...
Trying to not be a slacker anymore, I _have_ contacted H&aring;kan in hopes of persuading him to take the reins and officially manage the plugin at the centralized WordPress repository. If he agrees, you should be able to download the plugin here very shortly: "http://wordpress.org/extend/plugins/code-viewer/":http://wordpress.org/extend/plugins/code-viewer/
