...
* "LinkedIn":https://www.linkedin.com/in/aaronschaefer
</div>
...
ElasticDog.com is hosted directly on "Amazon S3":https://aws.amazon.com/s3/ utilizing their bucket's static website hosting feature set along with some support from "Route53":https://aws.amazon.com/route53/ for handling the special DNS(Domain Name System) requirements with this setup. The site itself is completely static, but uses a combination of "Jekyll":https://github.com/mojombo/jekyll with "RedCloth":https://redcloth.org/ to generate the HTML(Hypertext Markup Language), and "Compass":https://compass-style.org/ with "Sass":https://sass-lang.com/ to generate the CSS(Cascading Style Sheets). The site's syndication feed is also generated by Jekyll, but ultimately gets distributed via "FeedBurner":https://feedburner.google.com/.

h2(#design). Design

Although it wasn't my first website, I created ElasticDog.com when I began learning about web standards back in 2003. I started off using "Movable Type":https://www.movabletype.org/ as a blogging engine, and unfortunately neglected to convert all of my entries when I later switched to "WordPress":https://wordpress.org/. Over the years, I've updated the look of this site a number of times...click a banner below to be transported into the past.
...
The 2008 design of ElasticDog.com was not created by me, but was a highly-customized version of "Essay", a "Sandbox":https://www.plaintxt.org/themes/sandbox/ theme by "Ian Stewart":https://upperfortstewart.com/. The idea was that I could ignore the complexities of WordPress theme creation and get back to focusing on writing, but you can "see how that went":/archives/.

h3(#current). Current Design

The current design of ElasticDog.com (completed in October 2010) is another attempt at getting back to basics. I started with the idea of making the site look similar to output from "Readability":https://lab.arc90.com/experiments/readability/, but went further to enhance its typography, color palette, and structure to better represent the content I write. The design is intentionally minimal, but with close attention paid to the details.
